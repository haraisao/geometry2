...
public:
	...
	*/
#if WIN32
	[[deprecated]] void setEulerZYX(const tf2Scalar& yaw, const tf2Scalar& pitch, const tf2Scalar& roll) 
#else
...
#if WIN32
	[[deprecated]] void getEulerZYX(tf2Scalar& yaw, tf2Scalar& pitch, tf2Scalar& roll, unsigned int solution_number = 1) const
